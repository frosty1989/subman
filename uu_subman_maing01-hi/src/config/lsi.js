const Lsi = {
  appName: {
    cs: "Aplikace uuSubman",
    en: "Application uuSubman",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuSubman",
      en: "About application uuSubman",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuSubman.",
      en: "You can buy your own uuSubman.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuSubman.",
      en: "You don't have rights to initialize this uuSubman.",
    },
  },
